...
public abstract class Task<R, W> implements Runnable
{
   /**
    ...
    */
   protected abstract void updateMasterContext(W context);
    ...
    * @param context the master context
    */
   protected abstract void updateLocalContext(R context);
