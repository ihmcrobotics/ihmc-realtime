...
public class BarrierScheduler<C> implements Runnable
{
    ...
    */
   private final List<? extends Task<? super C, ? super C>> tasks;
    ...
    */
   public BarrierScheduler(Collection<? extends Task<? super C, ? super C>> tasks, C masterContext, TaskOverrunBehavior overrunBehavior)
   {
   ...
   public void run()
   {
      ...
      {
         Task<? super C, ? super C> task = tasks.get(i);
